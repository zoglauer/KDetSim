...
Double_t KField::DriftVelocity(Float_t cx,Float_t cy,Float_t cz, Float_t Charg, Float_t T, Double_t Neff, Int_t which)
{
Float_t E[4];
 CalFieldXYZ(cx,cy,cz,E);
E[0]*=1e4; 

 return((Mobility(E[0],T,Charg,Neff,which)*(Double_t)E[0])); 
}
